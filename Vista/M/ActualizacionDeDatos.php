...
<script>
  document.querySelector('#Label9').innerText = "Actualización De Datos";
  document.querySelector('#Label8').innerText = "Actualización De Datos";
</script>
...
<script src="../../Funciones/actualizaciondatosmonitor.js" ></script>

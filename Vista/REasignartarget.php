  ...
  <script>
  document.querySelector('#Label9').innerText = "Reasignación De Tarjeta";
  document.querySelector('#Label8').innerText = "Reasignación De Tarjeta";
</script>
<!-- Main content -->
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <div class="form-group">
                    <label for="exampleInputPassword1">Escribe el NUEVO Numero Tarjeta</label>
            ...
            <div class="col-md-4">                
                <div class="form-group">
                    ...
                    <select id="miSelect2" class="select2" style="width: 100%;">
